    ...
    <section className="relative overflow-hidden border-y border-line bg-ink py-20 text-paper sm:py-28">
      ...
      <div className="container-hla relative">
        <div className="grid gap-12 lg:grid-cols-[1.1fr_1fr] lg:items-center lg:gap-20">
          <div>
            <span className="eyebrow text-flame">The goal · 2025</span>
            <h2 className="display mt-5 text-[clamp(2rem,5vw,3.5rem)] text-white">
              HELP THREE YOUNG MAKERS REACH THEIR FIRST 100 CUSTOMERS.
            </h2>
            <p className="mt-6 max-w-lg text-base leading-relaxed text-white/60 sm:text-lg">
              Not 100.000 followers. Not a funding round. One hundred real people who paid real money for
              something three brothers designed, printed, checked and packed themselves.
            </p>
          ...
          <div>
            <div className="flex items-end justify-between">
              <div>
                ...
                <p className="eyebrow mt-2 text-white/40">Customers since {goal.startedAt}</p>
              </div>
              ...
              {cells.map((_, i) => {
                ...
                return (
                  <motion.span
                    ...
                    title={filled ? `Customer #${i + 1}` : isNext ? "This one could be you" : undefined}
                  />
                );
              })}
            </div>
            ...
            <p className="mt-5 text-xs leading-relaxed text-white/40">
              Every orange square is a real order that was designed, printed, checked and packed at home.
              The dashed one is next.
            </p>
          </div>
        </div>
      </div>
